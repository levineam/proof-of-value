...
Steem pioneered such a mechanism in its "proof of brain," and it worked before failures elsewhere in its design obscured its most innovative feature. Section 3 returns to what that experiment did and did not demonstrate.
...
The argument in Section 1 would be speculative if nothing had ever tried it. Something did. Steem ran a continuous, feeless, openly joinable mechanism of per-item upvotes and downvotes that allocated real issuance at social scale, and by the standards that matter for the claim being made here, it worked: content creation and user growth were exponential for a period, and the mechanism demonstrably moved newly issued currency toward what a crowd judged worth rewarding. This paper's central claim is not that such an algorithm is new. It is that the one system to demonstrate it was never evaluated on its own terms.
...
| Subjective proof of work (Steem lineage) | Stake-weighted continuous upvotes and downvotes over a fixed issuance | Continuous, per item | None | Open | Elected validator set, outside the reward rule |
